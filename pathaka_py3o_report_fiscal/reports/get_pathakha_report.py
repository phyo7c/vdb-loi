...
class HrEmployeeIncomeTaxReport(models.AbstractModel):
    _name = 'report.pathaka_py3o_report_fiscal.report_pathakha_print'
    _description = 'PaThaKha Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        income_tax_report = self.env['ir.actions.report']._get_report_from_name('pathaka_py3o_report_fiscal.report_pathakha_print')
        employees = self.env['hr.employee'].browse(data['form']['employee_ids'])
        return {
            'doc_ids': self.ids,
